    ...
    <div>
      ...
      <AnimatePresence>
        {favorites.length > 0 ? (
            ...
            <ul className="max-w-2xl w-full gap-4">
              {favorites.map((favorite: any) => (
                <motion.div
                  ...
                  key={favorite.id}
                  layout
                  className="p-4 flex max-w-[300px] mb-5  hover:shadow-2xl hover:shadow-sky-500/[0.1]  flex-col md:flex-row justify-between items-center hover:outline outline-1 outline-indigo-500 dark:hover:bg-neutral-800 transition-all duration-0.2s ease-in-out rounded-xl cursor-pointer "
                >
          ...
          <div className="flex flex-col items-center justify-center max-w-[300px] p-4">
            <h2 className="text-2xl text-center font-bold text-neutral-600 dark:text-neutral-200">
              No favorites yet
            </h2>
          </div>
        )}
